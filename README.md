...
|---------|-------------|--------------|
| **[Sentimental Analysis on Videos](https://github.com/mohan-akshay/Sentimental-analysis-on-videos)** | Combination of text sentimental analysis and facial emotion detection | Google Colab, Python, scikit-learn, Excel |
...
| **[Monday Coffee: Market Analysis](https://github.com/mohan-akshay/monday_coffee)** | SQL analysis of online sales data to identify the top 3 Indian cities for new coffee shop expansion based on sales, customers, and rent insights.  | PostgreSQL · SQL · Data Analysis |
| **[New York City Airbnb Analysis 2024](https://github.com/mohan-akshay/air_bnb_NYC)** | EDA of NYC Airbnb listings to analyze pricing, availability, and location trends across boroughs and room types. Identified key factors influencing rental prices and market hotspots.  | Python · Pandas · NumPy · Matplotlib · Seaborn · Jupyter Notebook |
| **[Walmart sales analysis](https://github.com/mohan-akshay/EDA_on_walmart_dataset)** | Data cleaning, feature engineering, and EDA on Walmart’s 10K Sales dataset to uncover sales trends, category performance, and peak hours. | Python, MySQL, Jupyter-Notebook |
| **[Employee Data Analysis](https://github.com/mohan-akshay/Employee-Data-Analysis)** | Data exploration using SQL  | SQL, Excel, Xampp |
| **[House Price Prediction](https://github.com/mohan-akshay/House-Price-Prediction-Linear-Regression)** | Basic house price prediction model using ML | Python, Jupyter Notebook |
...
| **[World Happiness Viz](https://github.com/mohan-akshay/Global_happiness_viz)** | Visualising World Happiness data from 2015 to 2019 with Top 10 and Bottom 10 countries treemap. | Power BI, Excel |
